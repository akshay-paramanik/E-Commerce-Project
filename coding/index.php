  ...
  <body>
    <div class="container">
      ...
      <div class="navbar">
        ...
        <div class="account">
        <?php if(isset($_SESSION['username'])) { $newid = $_SESSION['username']; $sqlf = "select * from user where id = $newid"; $resf = mysqli_query($con,$sqlf); ?>
            <img src="../images/user.png" alt="" /><br />
           <?php $counting = mysqli_num_rows($resf);
            if($counting){
                $newn = mysqli_fetch_assoc($resf); echo $newn['name']; }  ?>
      ...
      <div class="card">
        <h1>New Mobiles</h1>
        <div class="main-cart">
        <?php while($data=mysqli_fetch_assoc($res)){ $id=$data['id'];
      ...
      <div class="card">
        ...
        <div class="main-cart">
        <?php while($laptop=mysqli_fetch_assoc($res2)){ $id=$laptop['id']; 
      ...
      <div class="card">
        <h1>Best for you</h1>
        <div class="main-cart">
          <?php while($cloth=mysqli_fetch_assoc($res3)){ $id=$cloth['id'];
