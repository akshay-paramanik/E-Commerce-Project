        ...
        <div class="right-part">
            <div class="general">
                ...
                <table>
                    ...
                    <tr>
                        <td><?php echo ++$s1; ?></td>
                        <td><?php echo $table1['type']; ?></td>
                        <td><?php echo $table1['color']; ?></td>
                        <td><?php echo $table1['model_num']; ?></td>
                        <td><?php echo $table1['price']; ?></td>
                        <td><?php echo $table1['quantity']; ?></td>
                        <td><a href="viewlaptopD.php?id=<?php echo $table1['id']; ?>">..more</a>||<a href="action.php?laptop=delete&id=<?php echo $table1['id']; ?>">Delete</a></td>
                    </tr>
                    <?php }} ?>
                </table>
            </div>
